...
// Ask 42 (menu round 3 B2 "Strip"): the Nalati grassland jump — a key-art PLATE for the menu strip, not a biome (Nalati is not
// built). Generated by assets/design/menu/round3/build/gen-plate.sh (codex image_gen, the B2 mockup + the live garage as
// references); the raw is assets/art/raw/keyart-nalati.png, cropped to 2.4:1 by selection.json before the 1920 / 960 tiers.
add('keyart-nalati', '1536x1024', `Clean crisp saturated game render, no text except one NORDVIK fence banner, no UI, no letterbox. Midday in the Nalati grassland: a Xinjiang-style alpine steppe, rolling bright green meadow with wildflowers, a dirt trials line, dark spruce at the treeline, two white yurts on a far ridge, snow-capped Tian Shan peaks, a huge blue sky with towering cumulus, a small lake in the valley. Hero: the garage rider (blue-and-white tank trials bike, charcoal hoodie, open-face helmet with a peak, blue jeans) mid-air off a grassy kicker flying left to right, huge in the right two-thirds of the frame, dirt and grass spraying from the rear wheel; the left 38 % open sky and peaks for a title. Camera low, three-quarter front, tracking.`, { kind: 'keyart', biome: 'nalati' });
