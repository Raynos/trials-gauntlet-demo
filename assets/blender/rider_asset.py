...
def export(args):
    ...
    with tempfile.TemporaryDirectory(prefix=".rider-export-", dir=generated.parent) as directory:
        ...
        try:
            ...
            report = {"source": source_label, "sourceSha256": source_hash, "exportSha256": digest(staged_glb), "outfit": args.outfit, "lod": args.lod, "verified": json.loads(verified.stdout)}
