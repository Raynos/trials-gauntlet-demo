...
- Image 2 is a CROP of image 1 (scaled up, so it is blurry): the region to paint, the CANYON in the west: red sandstone mesas and slot canyons at the last of sunset, the winding river with its bridges, dry riverbeds, a single desert highway, scrub and pines in the gullies, the coast on the far left, the snow line beginning at the top right.
...
Output path (copy the generated PNG here, exactly): assets/design/worldmap/build/regions/canyon.png
