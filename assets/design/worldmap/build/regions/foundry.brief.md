...
- Image 2 is a CROP of image 1 (scaled up, so it is blurry): the region to paint, the FOUNDRY in the far north-east: a black-iron industrial hellscape lit from below, blast furnaces, tall stacks with smoke, slag rivers glowing molten orange, sparks, pipe bridges, the road along the shore, cold blue-grey haze over everything.
...
Output path (copy the generated PNG here, exactly): assets/design/worldmap/build/regions/foundry.png
