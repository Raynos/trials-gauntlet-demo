...
def run(p):
 ...
 cmd=['pnpm','exec','tsx','docs/evidence/riding-poses/goldens-round3/continue.mts',prefix,str(base), '240'] if prefix else ['pnpm','harness:bot',track,'--bike',bike,'--skill','3','--seeds','1','--jobs','1','--track-wall-s','300','--no-verify']
