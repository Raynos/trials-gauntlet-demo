# Stranger — b1-first-ride (bikePhysicsFactory-v2, src 2495d8d5, 2026-09-22T22:45:23.796Z, medians on rookie)

**INSUFFICIENT** — n = 0 completed on rookie (min 2) · cleared 0/0 · median attempts — · asserted 1 ≤ median ≤ 1.5 (1.5 × band top 1) and every counted session cleared · censored 2 (b1-first-ride-r4-s1-20260914-164224 abandoned at attempt 1; b1-first-ride-r4-s2-20260914-164224 abandoned at attempt 1) · excluded: 24 stale src, 0 other bike · median time to clear — · median calls — · median wall —

| session | agent | bike | status | attempts | cleared | time to clear | calls | wall | 1st cp call | died at | best attempt |
|---|---|---|---|---:|---|---:|---:|---:|---:|---|---|
| b1-first-ride-20260914-013710 | harness-smoke | rookie | done (stale src) | 5 | no | — | 19 | 2.8 min | 5 | crash@111m, crash@114m, crash@118m, crash@105m | — |
| b1-first-ride-20260914-051940 | s1 | rookie | done (stale src) | 4 | yes | 63.5 s | 58 | 9.1 min | 6 | crash@24m, crash@199m, crash@303m | #4 clear ticks 3877–7625 |
| b1-first-ride-20260914-051950 | s2 | rookie | done (stale src) | 2 | yes | 53.8 s | 47 | 6.3 min | 6 | crash@24m | #2 clear ticks 269–6461 |
| b1-first-ride-20260914-073444 | s3 | rookie | done (stale src) | 1 | yes | 44.1 s | 13 | 2.5 min | 3 | — | #1 clear ticks 0–5290 |
...
| b1-first-ride-r14b-s1-20260915-220131 | s1 | rookie | done (stale src) | 1 | yes | 42.9 s | 12 | 2.0 min | 3 | — | #1 clear ticks 0–5449 |
| b1-first-ride-r14b-s2-20260915-220131 | s2 | rookie | done (stale src) | 1 | yes | 40.8 s | 12 | 2.8 min | 3 | — | #1 clear ticks 0–5201 |
| b1-first-ride-r15-s1-20260915-225608 | s1 | rookie | done (stale src) | 1 | yes | 44.6 s | 15 | 1.7 min | 3 | — | #1 clear ticks 0–5644 |
...
| b1-first-ride-r4-s1-20260914-164224 | s1 | rookie | abandoned | 1 | no | — | 0 | 11583.0 min | — | — | — |
| b1-first-ride-r4-s1-20260914-191143 | s1 | rookie | done (stale src) | 1 | yes | 49.0 s | 13 | 2.4 min | 3 | — | #1 clear ticks 0–6115 |
| b1-first-ride-r4-s2-20260914-164224 | s2 | rookie | abandoned | 1 | no | — | 0 | 11583.0 min | — | — | — |
