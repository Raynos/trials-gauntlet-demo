# Stranger — e1-uphill-weight (bikePhysicsFactory-v2, src 2495d8d5, 2026-09-22T22:45:23.838Z, medians on rookie)

**INSUFFICIENT** — n = 0 completed on rookie (min 2) · cleared 0/0 · median attempts — · asserted 2 ≤ median ≤ 6.0 (1.5 × band top 4) and every counted session cleared · censored 2 (e1-uphill-weight-r4-s1-20260914-164224 abandoned at attempt 1; e1-uphill-weight-r4-s2-20260914-164224 abandoned at attempt 1) · excluded: 19 stale src, 0 other bike · median time to clear — · median calls — · median wall —
...
| e1-uphill-weight-r14b-s1-20260915-220131 | s1 | rookie | done (stale src) | 3 | yes | 63.8 s | 24 | 5.1 min | 3 | crash@227m, crash@211m (ramp) | #3 clear ticks 3305–7955 |
| e1-uphill-weight-r14b-s2-20260915-220131 | s2 | rookie | done (stale src) | 1 | yes | 52.0 s | 13 | 2.6 min | 3 | — | #1 clear ticks 0–6544 |
| e1-uphill-weight-r15-s1-20260915-225608 | s1 | rookie | done (stale src) | 3 | yes | 64.0 s | 19 | 2.9 min | 3 | crash@437m (plank), crash@461m | #3 clear ticks 5882–7976 |
...
| e1-uphill-weight-r4-s1-20260914-164224 | s1 | rookie | abandoned | 1 | no | — | 0 | 11583.0 min | — | — | — |
...
| e1-uphill-weight-r4-s2-20260914-164224 | s2 | rookie | abandoned | 1 | no | — | 0 | 11583.0 min | — | — | — |
