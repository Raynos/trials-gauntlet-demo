# Stranger — e3-stairway (bikePhysicsFactory-v2, src 1255af7f, 2026-09-21T12:03:30.508Z, medians on rookie)

**UNDER-BAND** — n = 2 completed on rookie (min 2) · cleared 2/2 · median attempts 1 · asserted 3 ≤ median ≤ 9.0 (1.5 × band top 6) and every counted session cleared · censored 2 (e3-stairway-r4-s1-20260914-164224 abandoned at attempt 1; e3-stairway-r4-s2-20260914-164224 abandoned at attempt 1) · excluded: 15 stale src, 0 other bike · median time to clear 41.6 s · median calls 11.5 · median wall 1.9 min

| session | agent | bike | status | attempts | cleared | time to clear | calls | wall | 1st cp call | died at | best attempt |
|---|---|---|---|---:|---|---:|---:|---:|---:|---|---|
| e3-stairway-20260921-065902 | poses-round3-e3-a | rookie | done | 1 | yes | 41.2 s | 11 | 0.7 min | 2 | — | #1 clear ticks 0–5280 |
| e3-stairway-20260921-070002 | poses-round3-e3-b | rookie | done | 1 | yes | 41.9 s | 12 | 3.1 min | 3 | — | #1 clear ticks 0–5361 |
...
| e3-stairway-r4-s1-20260914-164224 | s1 | rookie | abandoned | 1 | no | — | 0 | 9501.1 min | — | — | — |
...
| e3-stairway-r4-s2-20260914-164224 | s2 | rookie | abandoned | 1 | no | — | 0 | 9501.1 min | — | — | — |
