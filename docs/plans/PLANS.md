...
| **Blender hero (branch)** | `docs/plans/BLENDER_HERO.md` | rider/bike models, animation and Three.js integration to the Trials reference; Codex owns Blender on `blender-work` | round 7 checkpoint: shared knee geometry repaired, connected trousers promoted after playback; 84 recordings / 407,983 ticks repeat; 67,000 fresh ticks match V8/WebKit; B3 stranger median 1, M1 median 9 (n=2 each); Metal/WebKit clear/crash/restart pass; tests 19 fail / 714 pass / 11 todo, including 2 new hop regressions | — | round 8 coherent visual assembly: anatomical Street fit, Race boot/pant reconstruction, protected bike engine/body source, material/AO and self-shadow integration; played before/after gallery; physics regressions parked; actual iOS open; no merge |
