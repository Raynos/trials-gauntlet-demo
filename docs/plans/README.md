...
| **Riding poses** | [RIDING_POSES.md](RIDING_POSES.md) | seated neutral, forward, back, natural elbows, explicit contact release, runtime cloth — in played clips | **in qualification (ask 82)**: 50/50 exact Node/silent-browser finishing replays on 26 pre-Rockhop courses at source `207404d3` (47 bot controls, three stranger-derived); fresh M2 Pro bot and 12/12 new blind B1–E3 clears on this exact source. Current silent Rookie/Pro transition clips recorded. Typecheck/lint/build pass. Full integrated suite is red on 12 stale new Rockhop recordings, a loaded-host R5 timing row and integration noise; Metal cold boot/clear/crash/restart/offline pass, old physics pins repinned 6/6, synced GPU readback timing remains variable | ~85% of pose release readiness | qualify changed Rockhop recordings, clear integrated tests and full silent Metal gate, then deploy and verify production SHA |
