...
| **Riding poses** | [RIDING_POSES.md](RIDING_POSES.md) | seated neutral, forward, back, natural elbows, explicit contact release, runtime cloth — in played clips | **in progress — shared geometry implemented (ask 73)**: physical mass, sensors, live skeleton and crash release now agree; whole-body lean and impact response retuned; sleeve twist and rear-support trap corrected. Final physics fingerprint 1255af7f invalidates prior clear results; full outfit motion, fresh golden/browser and stranger qualification, and CPU timing remain open | — | parent played garment review; unchanged handling/cost gates; fresh both-class replays and strangers |
