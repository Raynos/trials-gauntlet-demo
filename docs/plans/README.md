...
| **Riding poses** | [RIDING_POSES.md](RIDING_POSES.md) | seated neutral, forward, back, natural elbows, explicit contact release, runtime cloth — in played clips | **paused at user request — qualification checkpoint (ask 73)**: shared anatomy, lean, release and cloth implemented. Fingerprint 1255af7f: 48 exact golden clears, 12 fresh-player replays, 60 reviewed motion combinations, Metal ship 31/31. Serial suite 1078 passes / one R8 failure / two skips; CPU bars pass | — | resolve actual-force availability in R8 recovery measurement; then final acceptance, archive and delivery. Resume: `docs/evidence/riding-poses/qualification-round3/PAUSE.md` |
