...
| **Riding poses** | [RIDING_POSES.md](RIDING_POSES.md) | seated neutral, forward, back, natural elbows, explicit contact release, runtime cloth — in played clips | **open — current-build audit (ask 73)**: authored seated/forward/back blends and two-bone arm IK already live; physics/drawn mismatch, excursion hiding, release and runtime cloth remain unclosed; 121 targeted baseline tests pass; forward lean prioritized; Evolution/Fusion/Rising research and physical retuning authorized | 20 | drawn-vs-physical CoM/reach measurement per pose, then the retune |
