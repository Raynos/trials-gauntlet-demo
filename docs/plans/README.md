...
| **World map level select** | [WORLD_MAP.md](WORLD_MAP.md) | the A "Rebirth" painted continent as the level select — pan / zoom over one continuous terrain, markers with leader-line plates, the route as a lit road, fog over locked regions, drifting cloud shadows; the diorama retired | **in build** (ask 54, started 2026-09-17) | 0 | plan doc + terrain plates first; played evidence at every round |
