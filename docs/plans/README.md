...
| **Native iOS / Android publishing** | [NATIVE_MOBILE_PUBLISHING.md](NATIVE_MOBILE_PUBLISHING.md) | Package the shared TypeScript / Three.js game with Capacitor; offline installation, store releases and an optional controlled web-update channel | **proposed; implementation not started** — ask 72 planning delivered; store-policy research checked 2026-09-21; no native projects or submissions | 0 | P0 publisher/toolchain scope; P1 fresh-install offline proof on both platforms; future human decisions HR-14 |
