...
| 37 | "/goal build CHROMIUM_METAL_SHADER_INIT.md until completion" | **done** | closed as non-repro: 18/18 clean unmodified Metal gate runs incl. the original failing build and pre-r15 (`docs/evidence/chromium-metal/`); plan archived; cold-cache residual → HR-08 |
