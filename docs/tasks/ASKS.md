...
| 25 | Garage on desktop (2000×1015, tier L): "look at this, it's so dumb" — rider corrupted, the set crude | **in flight** (set) | rider part **done** (see 26); the set re-dress is with the garage owner (resumed after the lid-close); desktop 2000×1015 is now a first-class geometry |
