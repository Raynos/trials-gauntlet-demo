# Stranger — b3-kicker-row (bikePhysicsFactory-v2, src 089e0885, 2026-09-16T03:24:27.595Z, medians on rookie)

**PASS** — n = 2 completed on rookie (min 2) · cleared 2/2 · median attempts 2 · asserted 1 ≤ median ≤ 3.0 (1.5 × band top 2) and every counted session cleared · censored 2 (b3-kicker-row-r4-s1-20260914-164224 abandoned at attempt 1; b3-kicker-row-r4-s2-20260914-164224 abandoned at attempt 1) · excluded: 13 stale src, 0 other bike · median time to clear 43.4 s · median calls 14.5 · median wall 3.0 min
...
| b3-kicker-row-r14b-s1-20260915-220131 | s1 | rookie | done | 2 | yes | 42.4 s | 13 | 2.7 min | 2 | crash@94m | #2 clear ticks 1072–5412 |
| b3-kicker-row-r14b-s2-20260915-220131 | s2 | rookie | done | 2 | yes | 44.5 s | 16 | 3.3 min | 2 | crash@94m | #2 clear ticks 1073–5649 |
...
| b3-kicker-row-r4-s1-20260914-164224 | s1 | rookie | abandoned | 1 | no | — | 0 | 1782.0 min | — | — | — |
...
| b3-kicker-row-r4-s2-20260914-164224 | s2 | rookie | abandoned | 1 | no | — | 0 | 1782.0 min | — | — | — |
...
Where they died (2 ended attempts over counted sessions):

| obstacle | deaths | x (m) |
|---|---:|---|
| ground | 2 | 94.2, 94.4 |

by reason: crash 2 · by checkpoint segment: [0, 2, 0, 0, 0]
