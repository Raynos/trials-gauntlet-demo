# Stranger — e1-uphill-weight (bikePhysicsFactory-v2, src 65175e2d, 2026-09-15T19:32:09.395Z, medians on rookie)

**FAIL** — n = 8 completed on rookie (min 2) · cleared 8/8 · median attempts 7 · asserted 2 ≤ median ≤ 6.0 (1.5 × band top 4) and every counted session cleared · censored 2 (e1-uphill-weight-r4-s1-20260914-164224 abandoned at attempt 1; e1-uphill-weight-r4-s2-20260914-164224 abandoned at attempt 1) · excluded: 0 stale src, 0 other bike · median time to clear 99.2 s · median calls 34 · median wall 12.3 min

| session | agent | bike | status | attempts | cleared | time to clear | calls | wall | 1st cp call | died at | best attempt |
|---|---|---|---|---:|---|---:|---:|---:|---:|---|---|
| e1-uphill-weight-20260914-051942 | s1 | rookie | done (stale src) | 9 | yes | 126.5 s | 97 | 16.8 min | 4 | crash@26m, crash@62m (plank), crash@84m, crash@216m, crash@298m (ramp), crash@298m (ramp), crash@292m, crash@306m (ramp) | #9 clear ticks 12733–15182 |
...
| e1-uphill-weight-r4-s1-20260914-164224 | s1 | rookie | abandoned | 1 | no | — | 0 | 1309.7 min | — | — | — |
...
| e1-uphill-weight-r4-s2-20260914-164224 | s2 | rookie | abandoned | 1 | no | — | 0 | 1309.7 min | — | — | — |
...
Where they died (55 ended attempts over counted sessions):

| obstacle | deaths | x (m) |
|---|---:|---|
| ground | 12 | 26.1, 83.8, 215.7, 291.6, 26.1, 158.6, 216, 291.5, 236.5, 319.9, 77.2, 525.6 |
| ramp @ 300.0 m | 7 | 297.7, 298.4, 299.1, 297.7, 299.7, 299.5, 300.1 |
| ramp @ 309.7 m | 5 | 305.8, 306.9, 311.2, 308.1, 310.8 |
| ramp @ 211.0 m | 5 | 210.5, 210.5, 210.4, 211.9, 210.6 |
| box @ 441.3 m | 5 | 443.2, 442.1, 442.2, 441.4, 442.5 |
| ramp @ 75.2 m | 4 | 71.5, 70.5, 71.5, 70.5 |
| plank @ 62.0 m | 3 | 62.4, 61.9, 60.6 |
| plank @ 436.5 m | 2 | 436.2, 437.4 |
| plank @ 201.0 m | 2 | 200.7, 200.9 |
| ramp @ 200.2 m | 2 | 197.2, 198.7 |
| ramp @ 449.9 m | 2 | 443.7, 444.6 |
| box @ 205.0 m | 1 | 205.2 |
| box @ 303.7 m | 1 | 303.8 |
| plank @ 300.8 m | 1 | 301.9 |
| ramp @ 435.7 m | 1 | 435.7 |
| ramp @ 133.2 m | 1 | 128.8 |
| ramp @ 265.0 m | 1 | 257.2 |

by reason: crash 53, restart 2 · by checkpoint segment: [2, 10, 11, 9, 23]
