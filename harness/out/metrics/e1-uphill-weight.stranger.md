# Stranger — e1-uphill-weight (bikePhysicsFactory-v2, src 089e0885, 2026-09-16T03:24:27.614Z, medians on rookie)

**PASS** — n = 2 completed on rookie (min 2) · cleared 2/2 · median attempts 2 · asserted 2 ≤ median ≤ 6.0 (1.5 × band top 4) and every counted session cleared · censored 2 (e1-uphill-weight-r4-s1-20260914-164224 abandoned at attempt 1; e1-uphill-weight-r4-s2-20260914-164224 abandoned at attempt 1) · excluded: 11 stale src, 0 other bike · median time to clear 57.9 s · median calls 18.5 · median wall 3.9 min
...
| e1-uphill-weight-r14b-s1-20260915-220131 | s1 | rookie | done | 3 | yes | 63.8 s | 24 | 5.1 min | 3 | crash@227m, crash@211m (ramp) | #3 clear ticks 3305–7955 |
| e1-uphill-weight-r14b-s2-20260915-220131 | s2 | rookie | done | 1 | yes | 52.0 s | 13 | 2.6 min | 3 | — | #1 clear ticks 0–6544 |
...
| e1-uphill-weight-r4-s1-20260914-164224 | s1 | rookie | abandoned | 1 | no | — | 0 | 1782.0 min | — | — | — |
...
| e1-uphill-weight-r4-s2-20260914-164224 | s2 | rookie | abandoned | 1 | no | — | 0 | 1782.0 min | — | — | — |
...
|---|---:|---|
| ground | 1 | 226.8 |
| ramp @ 211.0 m | 1 | 211.1 |

by reason: crash 2 · by checkpoint segment: [0, 0, 2, 0, 0]
