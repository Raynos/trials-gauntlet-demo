...
| **v0.2.0** | `b52dfd0`, 2026-09-15 (trailer cut on `9979b1b`) | `trailer.mp4`, `trailer-15s.mp4`, `trailer-sheet.jpg`, `trailer.cutlist.json` from the v0.2.0 cut (`harness/trailer/beats-v2.json`, 13 beats); `timelapse.mp4` = the wave-4 montage |
