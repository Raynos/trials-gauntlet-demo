...
base=Path(args.base).resolve();new=P/'public/assets/street01-denim-finish.glb';j,basebin=read(base);h,hbin=read(new);original=copy.deepcopy(j);blob=bytearray(basebin)
...
(P/'reports/denim-finish-assembly.json').write_text(json.dumps(r,indent=2)+'\n');print(json.dumps(r))
