...
R=Path.cwd();P=R/'prototypes/hero-garage';D=P/'art/helmet-remaster';O=P/'public/assets/variants';parser=argparse.ArgumentParser();parser.add_argument('--base',default='/tmp/street-r33-decoded.glb');args=parser.parse_args()
def read(p):
...
assert j['nodes']==original['nodes'] and j['meshes']==original['meshes'] and j['skins']==original['skins'] and j['animations']==original['animations'];charcoalsha=save(j,blob,D/'intermediate-charcoal.glb')
