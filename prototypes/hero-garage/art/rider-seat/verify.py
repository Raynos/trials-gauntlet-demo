...
R=Path.cwd();P=R/'prototypes/hero-garage';p=P/'public/assets/street01-rider-seat.glb';r=json.loads((P/'reports/rider-seat.json').read_text())
...
a,ab=glb(P/'public/assets/street01-rider-motion.glb');b,bb=glb(p)
