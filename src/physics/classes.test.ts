...
// The per-class golden-hash pin that lived here replayed a harness recording (`harness/inputs/flat-test/bot-3.json`)
// through v1; that file is regenerated by the bot on every physics change and the harness gate (D8 pinned-hash,
// `harness/gate/expected.json`) is the instrument that pins it. Removed at the v2 flip.
