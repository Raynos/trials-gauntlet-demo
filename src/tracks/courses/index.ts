...
export { FLAT_TEST_TRACK, GAP_TEST_TRACK, LAB_PHYSICS_TEST, LAB_FLAT_200, LAB_TRACKS };
...
/** Everything the registry knows: fixtures first, then the curriculum, then the lab tracks (`lab-*`, shown last under "Lab"). */
export const ALL_TRACKS: readonly TrackDef[] = [FLAT_TEST_TRACK, GAP_TEST_TRACK, ...CURRICULUM, ...LAB_TRACKS];
