/** Short, playable studies of the two Trials Evolution reference maneuvers.
...
export const LAB_BOX_CLIMB: TrackDef = course('lab-box-climb', 'Container Step', 'medium')
  .meta({
    biome: 'industrial',
...
export const LAB_RAMP_JUMP: TrackDef = course('lab-ramp-jump', 'Timber Launch', 'easy')
  .meta({
    biome: 'industrial',
